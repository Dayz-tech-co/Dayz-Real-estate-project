...
try {
    ...
    // Check OTP validity in system_otps table
    ...
    if (!empty($agent_data)) {
        $agent_name = $agent_data[0]['agency_name'];
        $agent_email = $agent_data[0]['email'];
